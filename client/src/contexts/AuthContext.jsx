...
export const AuthProvider = ({ children }) => {
  ...
  useEffect(() => {
    if (state.user) {
      // Simpan user di localStorage dengan format yang konsisten
      ...
      console.log('User tersimpan di localStorage:', state.user);
    }
  }, [state.user]);
  ...
  const logout = () => {
    ...
    localStorage.removeItem('user'); // Pastikan juga menghapus user dari localStorage
