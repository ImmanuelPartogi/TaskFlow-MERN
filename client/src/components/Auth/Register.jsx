      ...
      <div className="max-w-md w-full bg-white rounded-xl shadow-2xl overflow-hidden p-8 space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Mulai kelola proyek dan tugas Anda dengan mudah
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={onSubmit}>
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="password2" className="block text-sm font-medium text-gray-700 mb-1">Konfirmasi Password</label>
              <input
                id="password2"
                name="password2"
                type="password"
